...
const char *iftttPIRURL = "http://maker.ifttt.com/trigger/security_alert/with/key/b5LMZAcvBNkA2W7tTDxQt95X0J1TTgZE6IHXT8SVNSN";
const char *iftttLeakURL = "https://maker.ifttt.com/trigger/leak_alert/with/key/b5LMZAcvBNkA2W7tTDxQt95X0J1TTgZE6IHXT8SVNSN";
const char *iftttFireAlert = "http://maker.ifttt.com/trigger/fire_alert/with/key/b5LMZAcvBNkA2W7tTDxQt95X0J1TTgZE6IHXT8SVNSN";
  ...
  server.on("/setBlinds", HTTP_GET, []()
        ...
        if (server.hasArg("value")) {
            ...
            if (shouldMoveLeft) {
                ...
                for (int pos = currentBlindsPosition; pos >= newPosition; pos-=15) {
                    blindsServo.write(0);
